...
func Test_Delete_ReturnRecordNotFound_When_Campaing_does_not_exist(t *testing.T) {
	assert := assert.New(t)
...
func Test_Delete_ReturnStatusInvalid_When_Campaing_does_not_exist(t *testing.T) {
	assert := assert.New(t)
